...
curl -T ./target/CatUtils-${JAR_VERSION}.jar -u gamer4life:29ce028e88c860e37602a1e9deab1bffe4ea91a0 https://api.bintray.com/content/gamercatorg/CatUtils/CatUtils/$JAR_VERSION/CatUtils-$JAR_VERSION.jar
